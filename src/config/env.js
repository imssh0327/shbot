...
const { DISCORD_BOT_TOKEN, CLIENT_ID, GUILD_ID, YOUTUBE_API_KEY, RIOT_API_KEY, REDIS_URL } = process.env;
...
if (!REDIS_URL) throw new Error("REDIS_URL 이 .env 에 설정되지 않았습니다.");
